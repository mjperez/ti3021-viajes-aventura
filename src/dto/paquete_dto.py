...
class PaqueteDTO:
    ...
    def __init__(self, id:int | None, nombre:str, fecha_inicio: datetime, fecha_fin:datetime, precio_total:float, cupos_disponibles:int, politica_id: int, descripcion:str=None):
        self.id=id
        self.nombre=nombre

...
class ReservaDTO:
    ...
    def __init__(self, id:int, fecha_reserva:datetime, estado: str, monto_total: float, numero_personas: int, usuario_id: int, paquete_id: int | None = None, destino_id: int | None = None):
        self.id=id
